...
<?php
                                                    ...
                                                    $sql="SELECT * FROM photo_tb where cat='Sports'";
...
?>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-input" name="name" id="name" placeholder="Your Name" required="yes" />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-input" name="phone" id="phone" placeholder="Phone number" required="yes" />
                    </div>
                    <div class="form-group">
